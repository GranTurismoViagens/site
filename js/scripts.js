$(document).ready(function() {
	...
	$("#tipo-viagem").change(function() {
		if (this.value == "funcionarios") {
			$("#view-empresa").show();
		} else {
			$("#view-empresa").hide();
		}
	...
	$("#form-orcamento").submit(function(e) {
		...
		$.ajax({
		    ...
		    success : function(response) {
		    	alert('Obrigado pelo Interesse. \n\n Seu orçamento foi enviado com sucesso, aguarde nosso contato')
		    }
		});
	});
	...
	$("#form-contato").submit(function(e) {
		...
		$.ajax({
		    ...
		    dataType: "json",
		    success : function(response) {
		    	alert('Obrigado pelo Contato. \n\n Seu contato foi enviado com sucesso, aguarde nosso retorno.')
		    }
		});
	});
});